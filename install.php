...
$users = [
    [
        "user_name" => "jawad007",
        "user_pass" => "jawad1",
        "user_full_name" => "Ahmed Mujtaba Jawad"
    ],
    [
        "user_name" => "user2",
        "user_pass" => "pass2",
...
$blogs = [
    [
        "user_id" => 1,
        "post_title" => "Cold Day At Sindh University",
        "post_body" => "On a chilly day at the University of Sindh, a pervasive cold enveloped the campus, transforming its vibrant atmosphere into one of crisp stillness. The winter breeze whispered through the ancient trees, their bare branches standing in contrast to the usual lively greenery. Students, bundled in cozy layers, traversed the pathways with brisk determination, their breath visible in the frigid air. The cold day at the University of Sindh painted a serene scene, with the timeless architecture and hushed tones creating an ambiance of quiet reflection amidst the seasonal chill.",
        "post_public" => true,
        "post_date" => "2019-10-20" // YYYY-MM-DD
    ],
    [
        "user_id" => 2,
        "post_title" => "Life in Karachi",
        "post_body" => "Life in Karachi, a bustling metropolis on the shores of the Arabian Sea, is a dynamic tapestry woven with the threads of diversity and energy. This vibrant city, often referred to as the City of Lights never sleeps, with its streets teeming with activity at all hours. From the aromatic spice markets of Saddar to the glittering lights of Clifton Beach, Karachi is a city that embraces contrasts. It boasts a rich cultural heritage reflected in its historical landmarks, such as the Quaid's Mausoleum and Mohatta Palace, standing alongside the modern skyline marked by towering skyscrapers.",
        "post_public" => true,
        "post_date" => "2020-10-10" // YYYY-MM-DD
    ],
    [
        "user_id" => 1,
        "post_title" => "Lorem Impusm Dummy blog",
